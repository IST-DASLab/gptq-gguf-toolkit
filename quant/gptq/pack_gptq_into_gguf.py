...
class ModelBase:
    ...
    def prepare_tensors(self):
        ...
        for name, data_torch in chain(self.generate_extra_tensors(), self.get_tensors()):
            ...
            if name.removesuffix(".weight") in index_map:
                ...
                for new_name, data_torch in (self.modify_tensors(data_torch, name, bid)):
                    quantized_data = torch.load(str(self.dir_model_quant / index_map.get(name.removesuffix(".weight")) / "data.pth"), map_location="cpu", weights_only=True)
                    ...
                    # pre-process the quantized data
